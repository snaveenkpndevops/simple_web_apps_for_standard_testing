...
// For localhost (testing we use the below)
//const serverPort = 3001; 
//const serverURL = `http://localhost:${serverPort}/`;

// For Azure Web Apps (we use the below)
//const serverURL = `https://customer-backend-app-ckgya4dedudehkcr.centralindia-01.azurewebsites.net/`;

// Standard & Best way to pass env from .env file
